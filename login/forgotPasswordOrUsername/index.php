...
<p class="small text-warning form-warning-text">If you did not give us a <span class="font-bold">real email address</span> when you created your account, we cannot send you an email.
</p>
</div>
<div id="form-forgot-password-username" class="form-forgot-password-username">
<ul>
<li class="forget-password">
<img class="image-security" src="https://ishowrevival.up.railway.app/img/Login/security-key.png" alt="key">
<div class="forgot-password-container">
<h5>Forgot My Password</h5>
<div>Enter your username to reset your password.</div>
<div class="form-horizontal">
<div class="form-group" id="form-username">
<input id="username" class="form-control input-field" placeholder="Username" control-id="ControlID-3">
<p class="hidden form-control-label" id="form-username-error"></p>
</div>
<button id="forgot-password-btn" type="button" class="btn-fixed-width btn-primary-md" control-id="ControlID-4">Submit</button>
</div>
</div>
</li>
<li class="forgot-username">
<img class="image-security" src="https://ishowrevival.up.railway.app/img/login/security-account.png" alt="key">
<div class="forgot-password-container">
<h5>Forgot My Username</h5>
<div>Enter your email to retrieve your username.</div>
<div class="form-horizontal">
<div class="form-group" id="form-email">
<input id="email" class="form-control input-field" placeholder="Email" control-id="ControlID-5">
<p class="hidden form-control-label" id="form-email-error"></p>
</div>
<button id="forgot-username-btn" type="button" class="btn-fixed-width btn-primary-md" control-id="ControlID-6">Submit</button>
</div>
</div>
</li>
</ul>
