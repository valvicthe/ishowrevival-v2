...
<h5>Invite Key</h5>
<div>Enter your Invite Key to activate your account.</div>
<div class="form-horizontal">
<div class="form-group" id="form-username">
<input id="username" class="form-control input-field" placeholder="Key" control-id="ControlID-3">
...
<script type="text/javascript" src="https://ishowrevival.up.railway.app/js/invitekey.js"></script>
<script>
