...
<link onerror='Roblox.BundleDetector && Roblox.BundleDetector.reportBundleError(this)' rel='stylesheet' href="https://ishowrevival.up.railway.app/css/publishas.css" />
<link onerror='Roblox.BundleDetector && Roblox.BundleDetector.reportBundleError(this)' rel='stylesheet' href="https://ishowrevival.up.railway.app/css/assetlist.css" />
<script>
...
<script onerror='Roblox.BundleDetector && Roblox.BundleDetector.reportBundleError(this)' data-monitor='true' data-bundlename='studio' type='text/javascript' src="https://ishowrevival.up.railway.app/js/3719f3fb35135d05cf6b72d5b0f46333.js">
</script>
<script type='text/javascript'>
Roblox.config.externalResources = [];
Roblox.config.paths['Pages.Catalog'] = 'http://ishowrevival.up.railway.app/js/109d883fe3988fca757e26e341ed0fe8.js';
Roblox.config.paths['Pages.CatalogShared'] = 'http://ishowrevival.up.railway.app/js/33126cd3e259a404a2563594f55a3f06.js';
Roblox.config.paths['Widgets.AvatarImage'] = 'http://ishowrevival.up.railway.app/js/7d49ac94271bd506077acc9d0130eebb.js';
Roblox.config.paths['Widgets.DropdownMenu'] = 'http://ishowrevival.up.railway.app/js/da553e6b77b3d79bec37441b5fb317e7.js';
Roblox.config.paths['Widgets.HierarchicalDropdown'] =
'http://ishowrevival.up.railway.app/js/4a0af9989732810851e9e12809aeb8ad.js';
Roblox.config.paths['Widgets.ItemImage'] = 'http://ishowrevival.up.railway.app/js/61a0490ba23afa17f9ecca2a079a6a57.js';
Roblox.config.paths['Widgets.PlaceImage'] = 'http://ishowrevival.up.railway.app/js/a6df74a754523e097cab747621643c98.js';
</script>
<script onerror='Roblox.BundleDetector && Roblox.BundleDetector.reportBundleError(this)' data-monitor='true' data-bundlename='page' type='text/javascript' src="https://ishowrevival.up.railway.app/js/79e749bac5810474fd3195d27f63e209.js">
</script>
<script type="text/javascript">
...
Roblox.Endpoints.Urls['/game-auth/getauthticket'] = 'http://ishowrevival.up.railway.app/game-auth/getauthticket';
...
Roblox.Endpoints.Urls['/notification-stream/notification-stream-data'] = 'http://ishowrevival.up.railway.app/notification-stream/notification-stream-data';
Roblox.Endpoints.Urls['/api/friends/acceptfriendrequest'] = 'http://ishowrevival.up.railway.app/api/friends/acceptfriendrequest';
Roblox.Endpoints.Urls['/api/friends/declinefriendrequest'] = 'http://ishowrevival.up.railway.app/api/friends/declinefriendrequest';
...
<?php
$gamequery = $con->prepare("SELECT count(*) FROM `games` WHERE `creatorid`= :creatorid");
$gamequery->execute(['creatorid' => $uID]);
$gamecount = $gamequery->fetchColumn();
if($gamecount < 100 || $usr['Admin'] == 1){
?>
<div class="asset model" id="newasset" onclick="document.location.href ='http://ishowrevival.up.railway.app/ide/publish/newplace';">
<a class="model-image">
<img id="newModelImage" class="modelThumbnail" src="http://ishowrevival.up.railway.app/img/062d582034de086290214f59685f9090.png" alt="Create New" />
</a>
<p class="item-name-container ellipsis-overflow">(Create New)</p>
</div>
<? } ?>
<?php
$gamequery = $con->prepare("SELECT id,creatorid,name,icon FROM `games` WHERE `creatorid` = :creatorid");
$gamequery->execute(['creatorid' => $uID]);
...
$icon = $games['icon'];
echo'
<div class="asset model" id="newasset" onclick="document.location.href =\'http://ishowrevival.up.railway.app/ide/publish/editplace?placeId='.$placeId.'\';">
<a class="model-image">
<img id="newModelImage" class="modelThumbnail" src="https://ishowrevival.up.railway.app/img/games/'.$icon.'s.png" alt="'.NoXSSPlz($placename).'">
</a>
