...
?>
    ...
    <script onerror='Roblox.BundleDetector && Roblox.BundleDetector.reportBundleError(this)' data-monitor='true' data-bundlename='studio' type='text/javascript' src='https://ishowrevival.up.railway.app/js/3719f3fb35135d05cf6b72d5b0f46333.js'></script>
    ...
    <script onerror='Roblox.BundleDetector && Roblox.BundleDetector.reportBundleError(this)' data-monitor='true' data-bundlename='page' type='text/javascript' src='https://ishowrevival.up.railway.app/js/ef0183c0d9c6de80b589782211a8191c.js'></script>
...
<table id="build-page"
    ...
    <tr>
        <td class="menu-area divider-right">
                        ...
                        <a href="https://ishowrevival.up.railway.app/develop?View=9" class="tab-item tab-item-selected">Places</a>
        </td>

        <td class="content-area ">
                    <div class="creator-dashboard-redirection-banner" data-redirection-link="https://ishowrevival.up.railway.app/develop" data-redirection-page-name="Label.ViewPlacesPageName"></div>
...
echo'
    <table class="item-table"
        ...
        <tr>
            <td class="image-col">
                <a href="https://ishowrevival.up.railway.app/games/place?id='.$placeId.'" class="game-image" >
                    <img src="https://ishowrevival.up.railway.app/img/games/'.$icon.'s.png" alt="'.NoXSSPlz($placename).'" />
                </a>
            </td>
            <td class="name-col">
...
<script type="text/javascript">
    ...
    Roblox.BuildPage.AlertURL = "https://ishowrevival.up.railway.app/img/43ac54175f3f3cd403536fedd9170c10.png";
</script>
...
<script type="text/javascript">
    ...
    Roblox.BuildPage.Resources = {
        ...
        , questionmarkImgUrl: "https://ishowrevival.up.railway.app/images/Buttons/questionmark-12x12.png"
