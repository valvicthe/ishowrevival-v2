...
<div class="asset model" id="newasset" onclick="document.location.href ='http://ishowrevival.up.railway.app/ide/publish/newmodel';">
<a class="model-image">
...
<?php
$modelquery = $con->prepare("SELECT * FROM `library` WHERE `creatorid` = :creatorid AND `type2` = 'Model'");
$modelquery->execute(['creatorid' => $uID]);
while($models = $modelquery->fetch()) {
$modelId = $models['id'];
$modelname = $models['name'];
echo'
<div class="asset model" id="newasset" onclick="document.location.href =\'http://ishowrevival.up.railway.app/ide/publish/editmodel?placeId='.$modelId.'\';">
<a class="model-image">
<img id="newModelImage" class="modelThumbnail" src="https://ishowrevival.up.railway.app/model-thumbnails?assetId='.$modelId.'" alt="'.$modelname.'">
</a>
<p class="item-name-container ellipsis-overflow">'.$modelname.'</p>
</div>
';
}
?>
