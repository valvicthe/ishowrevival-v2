...
<div id="uploadProgressBar" data-upload-url="http://ishowrevival.up.railway.app/Data/Upload.ashx?assetid=<?=$placeId;?>&type=Place&ispublic=False" data-previous-url="http://ishowrevival.up.railway.app/ide/publish/newplace" data-newupload="False" data-assetid="<?=$placeId;?>" data-isplace="True" data-ispackage="False">
...
<input class="form-text-box" id="gameLink" name="gameLink" type="text" value="http://ishowrevival.up.railway.app/games/?id=<?=$placeId;?>/" />
</div>
</div>
<script type="text/javascript">
