...
?>{"Rank":<?=$countedrank;?>,"DisplayRank":"<?=$countedrank;?>","FullRank":null,"WasRankTruncated":false,"Name":"<?echo NoXSSPlz($usr['username']);?>","UserId":<?=$usr['id'];?>,"TargetId":<?=$usr['id'];?>,"ProfileUri":"https://ishowrevival.up.railway.app/users/<?=$usr['id'];?>/profile","ClanName":null,"ClanUri":null,"Points":<?=$pointcount;?>,"DisplayPoints":"<?=$Point_Format;?>","FullPoints":"<?=number_format($pointcount);?>","WasPointsTruncated":true,"ClanEmblemID":0,"UserImageUri":"https://ishowrevival.up.railway.app/headshot-thumbnails?userId=<?=$usr['id'];?>","UserImageFinal":true,"ClanImageUri":"","ClanImageFinal":false}<?php if($comma != $pointrowcount){echo",";} } ?>]